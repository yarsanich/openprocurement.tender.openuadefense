...
from openprocurement.api.tests.question import BaseTenderQuestionResourceTest as BaseTenderQuestionResourceTestApi
...
class TenderQuestionResourceTest(BaseTenderUAContentWebTest,BaseTenderQuestionResourceTest, BaseTenderQuestionResourceTestApi):
    test_tender_data = test_tender_data
    status = 'active.auction'

class TenderLotQuestionResourceTest(BaseTenderUAContentWebTest, BaseTenderLotQuestionResourceTest):
